...
const features = [
  ...
  },
  {
    icon: ListChecks,
    title: 'PYQ Tracker',
    desc: 'Track Previous Year Questions across subjects. Monitor accuracy and identify weak areas.',
    highlights: ['Subject-wise PYQs', 'Accuracy trends', 'Weak area alerts'],
  },
];
        ...
        <section ref={heroRef} className="relative pt-24 pb-16 sm:pt-32 sm:pb-24 px-4 min-h-[80vh] flex flex-col items-center justify-center">
          ...
          <motion.div style={{ opacity: heroOpacity }} className="relative z-10 text-center max-w-xl mx-auto space-y-6">
            <motion.div
              ...
              className="w-18 h-18 sm:w-22 sm:h-22 rounded-2xl gradient-primary flex items-center justify-center mx-auto shadow-glow w-[72px] h-[72px] sm:w-[88px] sm:h-[88px]"
            >
