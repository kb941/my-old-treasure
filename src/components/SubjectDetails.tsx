...
export function SubjectDetails({ subject, chapters, onChaptersChange, contentTypes, srSettings, forceExpanded, examName, studyLogs = [], mcqGoalPerTopic = 100 }: SubjectDetailsProps) {
