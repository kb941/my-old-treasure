          ...
          {expandedCard === 'score' && (
            <>
              <div className="text-center py-2">
                <p className="text-4xl font-bold text-gradient-primary">{prediction.predictedScore}/{markingScheme.totalMarks || 800}rkingScheme.totalMarks || 800}rkingScheme.totalMarks || 800}</p>
              </div>
              {scoreData.length > 0 && (
                <div className="h-40">
